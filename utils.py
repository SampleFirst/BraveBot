...
from info import *
from info import AUTH_CHANNEL, LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, LOG_CHANNEL, LOG_CHAT, LOG_GRP, GRP_LNK, CHNL_LNK, CUSTOM_FILE_CAPTION, IS_VERIFY, PROTECT_CONTENT, HOW_TO_VERIFY
